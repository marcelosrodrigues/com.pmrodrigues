...
class CartXMLRequestBuilder extends AkatusXMLRequestBuilder {
    ...
    private Element createTransactionElement(CartOperation operation) {
        ...
        final TipoPagamento paymentMethod = transaction
                .getPaymentMethod();
        ...
        if (paymentMethod == TipoPagamento.CARTAO_AMEX
                || paymentMethod == TipoPagamento.CARTAO_DINERS
                || paymentMethod == TipoPagamento.CARTAO_ELO
                || paymentMethod == TipoPagamento.CARTAO_MASTER
                || paymentMethod == TipoPagamento.CARTAO_VISA) {
            transactionElement.appendChild(createElementWithTextContent(
