package com.pmrodrigues.pagamentos.akatus;

import com.pmrodrigues.pagamentos.akatus.v1.cart.CartOperation;
import com.pmrodrigues.pagamentos.akatus.v1.paymentmethod.PaymentMethodsOperation;
import com.pmrodrigues.pagamentos.akatus.v1.status.StatusPagamentoOperation;
...
public class Akatus {
     ...
     * produção.
     *
     * @param email  {@link String} O email da conta do vendedor.
     * @param apiKey {@link String} A chave da Api definida no painel da conta do
     *               vendedor.
     */
     ...
     * execução.
     *
     * @param environment {@link Environment} O ambiente de execução das
     *                    operações da Api.
     * @param email       {@link String} O email da conta do vendedor.
     * @param apiKey      {@link String} A chave da Api definida no painel da conta do
     *                    vendedor.
    ...
    /**
     * @return {@link Environment} O ambiente onde as operações serão
     * executadas.
     */
