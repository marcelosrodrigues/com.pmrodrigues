...
(function ($, undefined) {
    ...
    $.Widget.prototype = {
        ...
        destroy: function () {
            ...
            // clean up eventlistener and states
...
(function ($, undefined) {
    ...
    $.ui.ddmanager = {
        ...
        dragStop: function (draggable, event) {
            ...
            //Call prepareOffsets one final time since IE does not fire return scroll eventlistener when overflow was caused by drag (see #5003)
            if (!draggable.options.refreshPositions) {
                $.ui.ddmanager.prepareOffsets(draggable, event);
            }
        }
...
(function ($, undefined) {
    ...
    $.widget("ui.sortable", $.ui.mouse, {
        ...
        _create: function () {
            ...
            //Initialize mouse eventlistener for interaction
            this._mouseInit();
        ...
        _mouseStart: function (event, overrideHandle, noActivation) {
            ...
            //Post "activate" eventlistener to possible containers
            if (!noActivation) {
        ...
        _mouseDrag: function (event) {
            ...
            //Post eventlistener to containers
        ...
        cancel: function () {
            ...
            if (this.dragging) {
                ...
                //Post deactivating eventlistener to containers
            ...
            if (this.placeholder) {
                //$(this.placeholder[0]).remove(); would have been the jQuery way - unfortunately, it unbinds ALL eventlistener from the original node!
        ...
        _clear: function (event, noPropagation) {
            ...
            // We delay all eventlistener that have to be triggered to after the point where the placeholder has been removed and
            ...
            if (this.cancelHelperRemoval) {
                if (!noPropagation) {
                    ...
                    } //Trigger all delayed eventlistener
...
// used to prevent race conditions with remote data sources
    ...
    $.widget("ui.autocomplete", {
        ...
        _create: function () {
            // Some browsers only repeat keydown eventlistener, not keypress eventlistener,
            // so we use the suppressKeyPress flag to determine if we've already
            // handled the keydown event. #7269
            // Unfortunately the code for & in keypress is the same as the up arrow,
            // so we use the suppressKeyPressRepeat flag to avoid handling keypress
            // eventlistener when we know the keydown event was used to modify the
            // search term. #7799
            ...
            this._on(this.menu.element, {
                ...
                menuselect: function (event, ui) {
                    ...
                    if (this.element[0] !== this.document[0].activeElement) {
                        ...
                        // #6109 - IE triggers two focus eventlistener and the second
...
(function ($, undefined) {
    ...
    $.extend(Datepicker.prototype, {
        ...
        _updateDatepicker: function (inst) {
            ...
            instActive = inst; // for delegate hover eventlistener
    ...
    /*
     * Bind hover eventlistener for datepicker elements.
...
(function ($) {
    ...
    $.widget("ui.tooltip", {
        ...
        _open: function (event, target, content) {
            ...
            //
            // We use removeAttr only for key eventlistener, to allow IE to export the correct
            // accessible attributes. For mouse eventlistener, set to empty string to avoid
