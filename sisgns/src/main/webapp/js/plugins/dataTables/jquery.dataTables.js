...
(/** @lends <global> */function (window, document, $, undefined) {
	 ...
	 *    } );
        ...
        /**
         * Fire callback functions and trigger eventlistener. Note that the loop over the
	 ...
	 *    } );
        ...
        _api_register('destroy()', function (remove) {
            ...
            return this.iterator('table', function (settings) {
                ...
                // Remove the DataTables generated nodes, eventlistener and classes
                jqTable.remove();
                jqWrapper.remove();
        ...
        DataTable.models.oSettings = {
             ...
             * destroy so they can clean up markup and eventlistener.
             *  @type array
             *  @default []
             */
            "aoDestroyCallback": [],
        ...
        // Information about eventlistener fired by DataTables - for documentation.
        /**
         * Draw event, fired whenever the table is redrawn on the page, at the same
         * point as fnDrawCallback. This may be useful for binding eventlistener or
	 ...
	 *     } );
         ...
         * can be used to remove bound eventlistener, added DOM nodes, etc.
