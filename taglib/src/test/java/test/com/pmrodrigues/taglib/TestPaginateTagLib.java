...
import com.pmrodrigues.taglib.PaginateTagLib;
...
public class TestPaginateTagLib {
    ...
    public void doTag() throws Exception {
        ...
        context.checking(new Expectations() {{
            ...
            allowing(resultlist).getQuantidadeDePaginas();
            will(returnValue(3L));

            allowing(resultlist).getNumeroDaPagina();
            will(returnValue(0L));

            allowing(resultlist).temPaginaAnterior();
            will(returnValue(Boolean.FALSE));

            allowing(resultlist).temProximaPagina();
        ...
        paginate.setUrl("/catalogo/loja/pesquisar.do");
        ...
        final String EXPECTED = "<div class=\"row\">" +
                "<div class=\"col-sm-5\">" +
                "<div class=\"dataTables_info\" id=\"dataTables-example_info\" role=\"alert\" aria-live=\"polite\" aria-relevant=\"all\">Pagina 1 de 3</div>" +
                "</div>" +
                ...
                "<a href=\"/catalogo/loja/pesquisar.do?page=0\">&lt;&lt;</a>" +
                "</li>" +
                "<li class=\"paginate_button\" tabindex=\"0\">" +
                "<a href=\"/catalogo/loja/pesquisar.do?page=0\">1</a>" +
                "</li>" +
                "<li class=\"paginate_button\" tabindex=\"1\">" +
                "<a href=\"/catalogo/loja/pesquisar.do?page=1\">2</a>" +
                "</li>" +
                "<li class=\"paginate_button\" tabindex=\"2\">" +
                "<a href=\"/catalogo/loja/pesquisar.do?page=2\">3</a>" +
                "</li>" +
                "<li class=\"paginate_button next \" aria-controls=\"dataTables-example\" tabindex=\"0\" id=\"dataTables-example_next\">" +
                "<a href=\"/catalogo/loja/pesquisar.do?page=1\">&gt;&gt;</a>" +
                "</li>" +
                "</ul>" +
                "</div>" +
                "</div>" +
    ...
    public void botaoNextHabilitado() {
        ...
        final String EXPECTED =
                "<li class=\"paginate_button next \" aria-controls=\"dataTables-example\" tabindex=\"0\" id=\"dataTables-example_next\">" +
                        "<a href=\"/catalogo/loja/pesquisar.do?page=2\">&gt;&gt;</a>" +
                        "</li>";
    ...
    public void botaoNextDesabilitado() throws Exception {
        ...
        final String EXPECTED =
                "<li class=\"paginate_button next disabled\" aria-controls=\"dataTables-example\" tabindex=\"0\" id=\"dataTables-example_next\">" +
                        "<a href=\"/catalogo/loja/pesquisar.do?page=3\">&gt;&gt;</a>" +
                        "</li>";
    ...
    public void testaMontagemsDaPaginacaoCentral() {
        ...
        for (int i = 0; i < 10; i++) {
            EXPECTED.append(String.format("<li class=\"paginate_button\" tabindex=\"%s\"><a href=\"/catalogo/loja/pesquisar.do?page=%s\">%s</a></li>", i, i, i + 1));
        }
