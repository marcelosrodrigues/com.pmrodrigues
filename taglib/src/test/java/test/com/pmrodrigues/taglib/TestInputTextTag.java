...
import com.pmrodrigues.taglib.InputTextTag;
...
public class TestInputTextTag {
    ...
    public void doTagWithOutError() throws Exception {
        ...
        String EXPECTED = "<div class=\"form-group \"><label for=\"object.nome\" class=\"control-label\">Nome</label><input type=\"text\" value=\"teste\" id=\"object.nome\" name=\"object.nome\" class=\"form-control\" placeholder=\"Nome\" /></div>";
    ...
    public void doTagRemovingLabel() throws Exception {
        ...
        final InputTextTag textview = new InputTextTag();
        textview.setJspContext(jspContext);
        String EXPECTED = "<div class=\"form-group \"><input type=\"text\" value=\"teste\" id=\"object.nome\" name=\"object.nome\" class=\"form-control\" placeholder=\"Nome\" /></div>";
